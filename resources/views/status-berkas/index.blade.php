<x-layout bodyClass="g-sidenav-show  bg-gray-200">
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div
                                ...
                                <h6 class="text-white text-capitalize ps-3 mb-0">Status Berkas table</h6>
    ...
    @push('js')
        <script>
            const FETCH_URL = "{{ route('status-berkas.data') }}";
            const DELETE_URL = "{{ route('status-berkas.bulk-delete') }}";
