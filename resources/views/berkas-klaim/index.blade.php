<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Berkas Klaim"></x-navbars.navs.auth>
        <!-- End Navbar -->
                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div
                                ...
                                @php
                                    $canCSO = auth()->user()->role->name === 'Customer Service Officer';
                                @endphp
    ...
    @push('js')
        <script>
            const FETCH_URL = "{{ route('berkas-klaim.data') }}";
